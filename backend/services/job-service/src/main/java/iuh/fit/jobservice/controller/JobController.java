...
public class JobController {
    ...
    // employer đổi trạng thái (DRAFT→PENDING | ACTIVE→PAUSED|CLOSED | PAUSED→ACTIVE)
    ...
    public ResponseEntity<?> searchJobs(
        ...
        PageResponse<JobResponse> response = jobService.searchJobs(search, industry, jobType, location, page, size);
        return ResponseEntity.ok(response);
    }
}
